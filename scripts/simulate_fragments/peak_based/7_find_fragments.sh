...
OUT_BED="fragments_cells/called_fragments.bed"
OUT_SORTED_BED="fragments_cells/called_fragments.sorted.tsv"
OUT_SORTED_BED_GZ="fragments_cells/called_fragments.sorted.tsv.gz"
