...
workflow {
    ...
    PROCESS_SIMULATE_FRAGMENT(ch_cells,ch_accessibility_score,ch_peak_file,
      ch_frag_size_dist,ch_blacklist,ch_gap_file,ch_centromere_file,ch_fragm_len_dist_out)
